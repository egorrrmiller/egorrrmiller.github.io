(function () {  
    ...
    // Регистрируем параметр в самом начале  
    Lampa.Params.select('custom_api_key', '', '');  
  
    function setupSettings() {  
        // Регистрируем компонент в системе настроек  
        ...
        // Добавляем параметр для ввода API ключа  
        Lampa.SettingsApi.addParam({  
            ...
            onChange: function (value) {  
                // Действие при изменении ключа  
                console.log('API ключ изменен:', value);  
            }  
        });  
    }  
